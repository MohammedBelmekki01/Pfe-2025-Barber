...
function AdminClientList({ reload }: AdminClientListProps) {
        ...
        return (
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <Button variant="secondary" className="w-full sm:w-auto">
              <Link
                to={`/admin/client-details?id=${client.id}`}
  ...
  useEffect(() => {
    ...
    window.addEventListener("client-updated", reloadListener);
    return () => window.removeEventListener("client-updated", reloadListener);
  }, [reload]);
