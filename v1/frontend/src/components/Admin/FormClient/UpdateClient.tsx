...
function UpdateClient({ client, onClientUpdated }: UpdateClientProps) {
  ...
  return (
    <div className="min-h-screen via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 p-6">
      <div className="max-w-2xl mx-auto">
        <Card className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border-0  ring-1 ring-gray-200/50 dark:ring-gray-700/50">
          <CardHeader className="text-center space-y-4 pb-8">
            <div className="mx-auto w-16 h-16 bg-gradient-to-r from-emerald-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
                Modify client information and keep profiles up to date
              </p>
            </div>
          </CardHeader>
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="pt-6">
                  <Button
                    type="submit"
                    className="w-full h-14 bg-gradient-to-r from-emerald-600 via-blue-600 to-emerald-700 hover:from-emerald-700 hover:via-blue-700 hover:to-emerald-800 text-white font-semibold text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 border-0"
                  >
